...
def main():
    ...
    assert accounting['static_main_bundles']==553 and accounting['static_padding_bundles']==896
    ...
    report=dict(source_sha256=digest,production_changes_confined_to_generated_block=True,
                ...
                scratch_live_peak=primary['lane_live_peak'])
    assert report['static_bundles']==11049 and bound['bound']==909
